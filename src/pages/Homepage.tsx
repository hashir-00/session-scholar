  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-amber-50/50">
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 bg-clip-text text-transparent">
            ...
            >
              <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 bg-white/90 backdrop-blur-sm hover:scale-105 group">
                <CardHeader className="text-center pb-4">
                  <div className={`h-20 w-20 rounded-3xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mx-auto mb-6 shadow-2xl border-2 border-white/30 group-hover:shadow-amber-500/25 group-hover:scale-110 transition-all duration-300 group-hover:shadow-[0_25px_50px_-12px_rgba(245,158,11,0.25)]`}>
                    {feature.icon}
                  </div>
                  <CardTitle className="text-xl mb-3 text-gray-900 group-hover:text-amber-700 transition-colors duration-300">{feature.title}</CardTitle>
                </CardHeader>
      ...
      <section className="container mx-auto px-4 py-20 bg-white/50 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            ...
            >
              <div className="h-20 w-20 rounded-full bg-gradient-to-r from-amber-600 to-orange-600 flex items-center justify-center mx-auto mb-6 text-white shadow-lg">
                {step.icon}
              </div>
              <div className="text-sm font-semibold text-amber-600 mb-2">STEP {step.step}</div>
      ...
      <section className="container mx-auto px-4 py-20">
        <motion.div 
          className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-3xl p-12 text-center text-white shadow-2xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          ...
          <Button 
            size="lg" 
            onClick={handleGetStarted}
            className="bg-white text-amber-600 hover:bg-gray-100 text-lg px-8 py-6 shadow-lg"
          >
            <Upload className="h-5 w-5 mr-2" />
